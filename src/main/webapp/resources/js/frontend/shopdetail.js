...
$(function(){
	...
	var listUrl = '/o2oCity/frontend/listproductsbyshop';
	...
	var productName = '';
	var productName = '';
	var searchDivUrl = '/o2oCity/frontend/listshopdetailpageinfo?shopId='+shopId;
	...
	function getSearchDivData(){
	    ...
	    function addItems(pageSize,pageIndex){
	    	var url = listUrl + '?' + 'pageIndex=' +pageIndex+'&pageSize='
	    	         +pageSize+'&productCategoryId='+productCategoryId+'&productName='
